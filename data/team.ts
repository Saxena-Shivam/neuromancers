...
export const domainLeads: DomainLeadGroup[] = [
  {
    ...
    members: [
      ...
      },
      {
        ...
        domain: "Competitive Programming (CP) Web Development",
        image:
          "/profile/optimized/IMG_20250607_111606.jpg (1) - AMIT KUMAR.webp",
      ...
      },
      {
        ...
        domain: "Competitive Programming (CP)",
        image:
          "/profile/optimized/IMG20240610154643-EDIT - KOMMURU JAYASURYA.webp",
...

      {
        ...
        role: "Member",
        domain: "Competitive Programming (CP) Web Development",
        image: "/profile/optimized/IMG_20260126_202629 - ABHINABA DE ROY.webp",
      ...
      },
      {
        ...
        domain: "Competitive Programming (CP) Machine Learning / AI",
        image:
          "/profile/optimized/IMG_20260130_194135 - ARIT SHARAD GANDHI.webp",
  ...
  },
  {
    ...
    members: [
      ...
      },
      {
        ...
        image: "/profile/optimized/1754840040491 - Akshit Meshram.webp",
...

  {
    ...
    members: [
      ...
      },
      {
        ...
        role: "Member",
        domain: "Competitive Programming (CP) Machine Learning / AI",
        image: "/profile/optimized/ashish-gowda.webp",
...

      {
        ...
        role: "Member",
        domain: "Competitive Programming (CP) Machine Learning / AI",
        image: "/profile/optimized/IMG-20250906-WA0047 - PATIL SAMIKSHA.webp",
...
export const members: TeamMember[] = [
  ...
  // Add inside "App Development" category members array
  {
    ...
    image: "/profile/optimized/Nilaksh Jha  - Nilaksh Jha.webp",
...
export const alumni: TeamMember[] = [
  {
    ...
    image: "/profile/optimized/IMG_20260205_103745 - RACHIT JAIN.webp",
  ...
  },
  {
    ...
    role: "Governor",
    domain: "Competitive Programming (CP) Web Development App Development",
    image: "/profile/optimized/AyushGuptaImage - ayush gupta.webp",
