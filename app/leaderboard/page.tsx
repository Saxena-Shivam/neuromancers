...
const leaderboardData: LeaderboardEntry[] = [
  ...
  },
  {
    ...
    previousRank: 5,
    name: "Neha Gupta",
    image: "https://images.unsplash.com/photo-1534528741775-af0119f7cbe7?w=100&h=100&fit=crop",
    year: "3rd Year",
    branch: "EE",
  ...
  },
  {
    ...
    previousRank: 8,
    name: "Vikram Singh",
    image: "https://images.unsplash.com/photo-1519085360798-e69530286df2?w=100&h=100&fit=crop",
    year: "4th Year",
    branch: "CSE",
...
type SortKey = "rank" | "codeforcesRating" | "codechefRating" | "leetcodeRating" | "problemsSolved";
          ...
          <div className="container mx-auto px-4 lg:px-8 relative">
            ...
            >
              ...
              <p className="mt-6 text-lg text-muted-foreground">
                Track our members competitive programming rankings across platforms.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="flex justify-center items-end gap-4 md:gap-8">
              ...
              >
                ...
                <h3 className="font-semibold text-sm md:text-base">{topThree[1]?.name}</h3>
                <p className="text-xs text-muted-foreground">{topThree[1]?.codeforcesRating} CF</p>
              ...
              >
                ...
                <h3 className="font-semibold text-sm md:text-base">{topThree[0]?.name}</h3>
                <p className="text-xs text-muted-foreground">{topThree[0]?.codeforcesRating} CF</p>
              ...
              >
                ...
                <h3 className="font-semibold text-sm md:text-base">{topThree[2]?.name}</h3>
                <p className="text-xs text-muted-foreground">{topThree[2]?.codeforcesRating} CF</p>
