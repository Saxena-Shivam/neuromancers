...
export function Testimonials() {
  ...
  const testimonials = alumniData
    .filter((alumni) => alumni.testimonial)
    .map((alumni) => ({
      id: alumni.id,
      quote: alumni.testimonial as string,
      author: alumni.name,
      role: `${alumni.role} @ ${alumni.company}`,
      batch: `Batch of ${alumni.batch}`,
      image: alumni.image,
    }));
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {testimonials.length === 0 ? (
            <div className="col-span-full text-center p-8 rounded-2xl bg-background border border-border text-muted-foreground">
